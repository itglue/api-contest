...
$url = 'https://secrets.xxxxxxxxxx.com/webservices/sswebservice.asmx';
$username = 'xxxxxxxxxx'
$password = 'xxxxxxxxx'
...
#ITGlue API key
$apikeyitg = 'ITG.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
...
$count
    ...
    $SaveData | Add-Member -Name secretid -MemberType NoteProperty -Value $count -erroraction 'silentlycontinue'
...
$SaveData | export-csv -Path c:\temp\thyoticupdate1.csv -NoTypeInformation